...
//      }
      steps {
        sh 'docker build -t 008089408493.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME} .'
        ...
        sh 'docker push 008089408493.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME}'
      }
    }
